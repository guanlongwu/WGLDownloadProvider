#
#  Be sure to run `pod spec lint WGLDownloadProvider.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/guanlongwu/WGLDownloadProvider.git", :tag => "#{spec.version}" }
